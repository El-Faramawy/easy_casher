...
class ApiNormalPurchaseController extends Controller
{
    public function __construct()
    {
        $this->middleware(['auth:api','apiPermission:purchasesDepartment'])
            ->only([
                'makePurchaseOrder',
                'purchaseOrders',
    ...
    public function makePurchaseOrder(Request $request)
    {
        ...
        return response()->json(['message'=>'purchase Order Has Created'],200);
    }//end fun
    ...
    public function deletePurchaseOrder(Request $request)
    {
        ...
        $purchase->delete();
        return response()->json(['message'=>'Normal purchase Order Had been Deleted'],200);
    }//end fun
}
