...
if (!function_exists('checkApiUserHavePermission')) {
    function checkApiUserHavePermission($user , $permission_name)
    {
        if (in_array($permission_name,$user->permissions()->pluck('name')
            ->toArray()))
        {
            return true;
        }
...
if (!function_exists('phone_codes')) {
