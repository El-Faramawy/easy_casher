 ض  @extends('admin.layouts.layout')
@section('styles')
    <!-- Data Tables -->
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">الباقات</h5>
    ...
    <script>
        ...
        $("#basicExample").DataTable({
            ...
            "columns": [
                ...
                {"data": "num_of_days",   orderable: false,searchable: true},
                {"data": "is_free",   orderable: false,searchable: false},
                {"data": "is_shown",   orderable: false,searchable: false},
        ...
        $(document).on('click', '#bulk_delete', function () {
            ...
            if (id.length > 0) {
                swal({
                    ...
                    $.ajax({
                        url: '{{route('packages.delete.bulk')}}',
                        type: 'DELETE',
                        data: {id: id},
                        success: function (data) {
                            swal.close()
