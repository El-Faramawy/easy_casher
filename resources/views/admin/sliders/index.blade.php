...
@section('content')
            ...
            <div class="table-container">
                <div class="t-header">
                    ...
                    {{--                    <button id="checkAll" class="btn btn-info pull-left"> الكل <span class="icon-check"></span>  </button>
                                        <button id="bulk_delete" class="btn btn-danger pull-left"> حذف الكل <span class="icon-delete"pan>  </button>

                                        <button id="all_sliders" class="btn btn-dark pull-left">عرض البنر <span class="icon-show_chart"></span>  </button>
                    --}}
                </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">البانر</h5>
    ...
    <div  id="slider-model" class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">البانر</h5>
                ...
                <div class="modal-body" id="form-for-slider">
                    @include('admin.sliders.parts.sliders')
                </div>
                <div class="modal-footer">
...
@section('js')
    ...
    <script>
        ...
        $(document).on('click','#all_sliders',function (e) {
            e.preventDefault()
            $('#slider-model').modal('show')
        });
    </script>
@endsection
