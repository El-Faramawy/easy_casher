...
@section('content')
					...
					<div class="routeNav">
						...
						<ul>
							...
							<li>
								<a href="#!" class="active"> فاتورة شراء </a>
							</li>
						</ul>
					</div>
					<!-- ================ /routeNav ================= -->
			...
			<div class="modal-dialog modal-lg  modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="SaleModalLabel"> فاتورة شراء </h5>
					...
					<form>
						<div class="modal-body">
							...
							<div class="row align-items-end">
								...
								<div class="col-4 p-1">
									<button type="button" class="btn btn-primary addClintBtn"> اضف مورد </button>
								</div>
							</div>
